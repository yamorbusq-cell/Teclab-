...
/*
 * Para reducir el efecto de rebote que ocurre al alcanzar el borde de
 * desplazamiento en iOS u otros visores móviles, añadimos un
 * controlador adicional de DOMContentLoaded que configura
 * escuchadores de eventos táctiles. Este código detecta cuando el
 * usuario está intentando desplazar más allá del inicio o del final
 * del contenedor `.scroll-container` y, en ese caso, evita el
 * comportamiento por defecto que provoca el rebote.
 */
document.addEventListener("DOMContentLoaded", () => {
  ...
  document.body.addEventListener(
    ...
    (e) => {
      ...
      lastTouchY = currentY;
      // Buscar el contenedor scrollable (scroll-container) en la cadena de padres
      let node = e.target;
      ...
      if (scrollContainer) {
        ...
        // Evitar el desplazamiento fuera del contenedor scrollable
        e.preventDefault();
      }
    },
    { passive: false }
